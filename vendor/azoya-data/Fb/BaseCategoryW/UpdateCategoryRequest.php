...
class UpdateCategoryRequest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return UpdateCategoryRequest
     */
    public static function getRootAsUpdateCategoryRequest(ByteBuffer $bb)
    {
     ...
     * @return void
     */
    public static function startUpdateCategoryRequest(FlatBufferBuilder $builder)
    {
     ...
     * @return UpdateCategoryRequest
     */
    public static function createUpdateCategoryRequest(FlatBufferBuilder $builder, $operator_id, $website_id, $category_id, $name, $include_in_menu, $status, $attr_value)
    {
        $builder->startObject(7);
     ...
     */
    public static function endUpdateCategoryRequest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
