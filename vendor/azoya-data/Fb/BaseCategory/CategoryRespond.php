...
class CategoryRespond extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return CategoryRespond
     */
    public static function getRootAsCategoryRespond(ByteBuffer $bb)
    {
        $obj = new CategoryRespond();
     ...
     * @return void
     */
    public static function startCategoryRespond(FlatBufferBuilder $builder)
    {
     ...
     * @return CategoryRespond
     */
    public static function createCategoryRespond(FlatBufferBuilder $builder, $code, $err_msg, $categories)
    {
        $builder->startObject(3);
     ...
     */
    public static function endCategoryRespond(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
