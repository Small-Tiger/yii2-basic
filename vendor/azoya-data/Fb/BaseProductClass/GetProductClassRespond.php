...
class GetProductClassRespond extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GetProductClassRespond
     */
    public static function getRootAsGetProductClassRespond(ByteBuffer $bb)
    {
        $obj = new GetProductClassRespond();
     ...
     * @return void
     */
    public static function startGetProductClassRespond(FlatBufferBuilder $builder)
    {
     ...
     * @return GetProductClassRespond
     */
    public static function createGetProductClassRespond(FlatBufferBuilder $builder, $code, $err_msg, $product_classes)
    {
        $builder->startObject(3);
     ...
     */
    public static function endGetProductClassRespond(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
