...
class UpdateCategoryParentRequest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return UpdateCategoryParentRequest
     */
    public static function getRootAsUpdateCategoryParentRequest(ByteBuffer $bb)
    {
        $obj = new UpdateCategoryParentRequest();
     ...
     * @return void
     */
    public static function startUpdateCategoryParentRequest(FlatBufferBuilder $builder)
    {
     ...
     * @return UpdateCategoryParentRequest
     */
    public static function createUpdateCategoryParentRequest(FlatBufferBuilder $builder, $operator_id, $website_id, $category_id, $parent_id)
    {
        $builder->startObject(4);
     ...
     */
    public static function endUpdateCategoryParentRequest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
