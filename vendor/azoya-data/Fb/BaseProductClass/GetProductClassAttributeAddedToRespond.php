...
class GetProductClassAttributeAddedToRespond extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GetProductClassAttributeAddedToRespond
     */
    public static function getRootAsGetProductClassAttributeAddedToRespond(ByteBuffer $bb)
    {
        $obj = new GetProductClassAttributeAddedToRespond();
     ...
     * @return void
     */
    public static function startGetProductClassAttributeAddedToRespond(FlatBufferBuilder $builder)
    {
     ...
     * @return GetProductClassAttributeAddedToRespond
     */
    public static function createGetProductClassAttributeAddedToRespond(FlatBufferBuilder $builder, $code, $err_msg, $product_classes)
    {
        $builder->startObject(3);
     ...
     */
    public static function endGetProductClassAttributeAddedToRespond(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
