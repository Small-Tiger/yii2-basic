...
class GetProductInfoRespond extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GetProductInfoRespond
     */
    public static function getRootAsGetProductInfoRespond(ByteBuffer $bb)
    {
        $obj = new GetProductInfoRespond();
     ...
     * @return void
     */
    public static function startGetProductInfoRespond(FlatBufferBuilder $builder)
    {
     ...
     * @return GetProductInfoRespond
     */
    public static function createGetProductInfoRespond(FlatBufferBuilder $builder, $code, $err_msg, $product_infos)
    {
        $builder->startObject(3);
     ...
     */
    public static function endGetProductInfoRespond(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
