...
class GetProductDescriptionRequest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GetProductDescriptionRequest
     */
    public static function getRootAsGetProductDescriptionRequest(ByteBuffer $bb)
    {
        $obj = new GetProductDescriptionRequest();
     ...
     * @return void
     */
    public static function startGetProductDescriptionRequest(FlatBufferBuilder $builder)
    {
     ...
     * @return GetProductDescriptionRequest
     */
    public static function createGetProductDescriptionRequest(FlatBufferBuilder $builder, $website_id, $product_ids)
    {
        $builder->startObject(2);
     ...
     */
    public static function endGetProductDescriptionRequest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
