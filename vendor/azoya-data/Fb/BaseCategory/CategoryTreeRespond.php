...
class CategoryTreeRespond extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return CategoryTreeRespond
     */
    public static function getRootAsCategoryTreeRespond(ByteBuffer $bb)
    {
        $obj = new CategoryTreeRespond();
     ...
     * @return void
     */
    public static function startCategoryTreeRespond(FlatBufferBuilder $builder)
    {
     ...
     * @return CategoryTreeRespond
     */
    public static function createCategoryTreeRespond(FlatBufferBuilder $builder, $code, $err_msg, $categories)
    {
        $builder->startObject(3);
    ...
    {
        $builder->addOffsetX(2, $categories, 0);
    }
     ...
     */
    public static function endCategoryTreeRespond(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
