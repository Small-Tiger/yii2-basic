...
class CategoryProductPositionRequest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return CategoryProductPositionRequest
     */
    public static function getRootAsCategoryProductPositionRequest(ByteBuffer $bb)
    {
        $obj = new CategoryProductPositionRequest();
     ...
     * @return void
     */
    public static function startCategoryProductPositionRequest(FlatBufferBuilder $builder)
    {
     ...
     * @return CategoryProductPositionRequest
     */
    public static function createCategoryProductPositionRequest(FlatBufferBuilder $builder, $website_id, $category_id, $product_class_id, $product_ids)
    {
        $builder->startObject(4);
     ...
     */
    public static function endCategoryProductPositionRequest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
